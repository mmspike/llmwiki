...
| **CVE Name** | [CVE-2025-40902](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2025-40902) |
...
## Impact
- An authenticated user with **administrative privileges** can create a malicious user with HTML tags in the username.
- When a victim attempts to **delete a group** containing the affected user, the injected HTML renders in their browser.
...
- **Review usernames** of existing users for suspicious content.
